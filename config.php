...
define('CONTACTFORM_FROM_ADDRESS', 'strikersavings@gmail.com');
define('CONTACTFORM_FROM_NAME', 'Striker Savings On The Go!');
...
define('CONTACTFORM_TO_ADDRESS', 'asimmnomiya0@gmail.com');
define('CONTACTFORM_TO_NAME', 'Hey There');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'strikersavings@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'cdrc aetb yehj woqj');
